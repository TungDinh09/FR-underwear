        ...
        <div class="main main-active">
          ...
          <div class="tables">
            <div class="last-appointments">
              <div class="heading">
                <h2>Product</h2>
                <a href="/addProduct" class="btn">Insert product</a>
              </div>
              <table class="appointments">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td><a href="/admin/product_detail/{{$product->id}}"><i class="fa-solid fa-download" style="color: rgb(255, 255, 255); background-color: rgb(10, 183, 125);"></i></a></td>
                      <td>
                        <i class="fa-solid fa-eye"></i>
                        <a href="/admin/product_edit/{{$product->id}}"><i class="fa-regular fa-pen-to-square"></i></a>
                       <form class="delete-form" action="/admin/product_delete/{{$product->id}}" method="post" >
                        @method('DELETE')
                        @csrf
