        ...
        <div class="main main-active">
          ...
          <div class="tables">
            <div class="last-appointments">
              <div class="heading">
                <h2>Category</h2>
                <a href="" class="btn">Insert Category</a>
              </div>
                ...
                <tbody>
                  @foreach ($categories as $category)
                    ...
                    <td>
                      ...
                      <a href="/admin/category_edit/{{$category->id}}"><i class="fa-regular fa-pen-to-square"></i></a>
                      <form class="delete-form" action="/admin/category_delete/{{$category->id}}" method="post" >
                              @method('DELETE')
                              @csrf
            ...
            <div class="doctor-visiting">
                <div class="heading">
                      <h2>Insert Catetory</h2>
                      <a href="" class="btn">View All</a>
                  </div>
            <form action="/admin/category_insert" method="POST">
