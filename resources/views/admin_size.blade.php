        ...
        <div class="main main-active">
          ...
          <div class="tables">
                  ...
                  @foreach ($sizes as $size) 
                      <tr>
                          ...
                          <td>
                              ...
                              <a href="/admin/size_edit/{{$size->id}}"><i class="fa-regular fa-pen-to-square"></i></a>
                              <form class="delete-form" action="/admin/size_delete/{{$size->id}}" method="post" >
            ...
            <div class="doctor-visiting">
              ...
              <form action="/admin/size_insert" method="POST">
                ...
                @csrf
                <div>
                  <label for="username">Size</label><br />
                  <input type="text" id="size" name="size"/><br />
                  <span class="text-danger" style="color:red;">@error('size') {{$message}} @enderror</span>
                </div>
